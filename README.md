...
> Morse decoder is a collection of methods used to decode morse characters to English letters, words and sentences.
...
> This use this project, install Ruby on your local machine and then clone the project.
...
- Ruby
- Visual studio code editor or any other code editor
- Git
...
1. cd to your_folder
2. git clone https://github.com/anbehindY/Morse-decoder.git
3. cd Morse-decoder
...
Feel free to check the [issues](https://github.com/anbehindY/Morse-decoder/issues).
...
Great thanks to Microverse's code reviewers and to everyone who reviewed my project and made suggestions.
